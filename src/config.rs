...
pub struct Config {
    ...
    /// Base URL of the srvcs-intersection dependency.
...
impl Config {
    pub fn from_vars(
        ...
        log: Option<String>,
        env: Option<String>,
        intersection_url: Option<String>,
    ) -> Self {
        let bind_addr = bind
        ...
        Config {
            ...
            intersection_url: intersection_url
    ...
    pub fn from_env() -> Self {
        Self::from_vars(
            ...
            std::env::var("SRVCS_INTERSECTION_URL").ok(),
        )
    }
}
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.intersection_url, "http://127.0.0.1:8081");
    }
